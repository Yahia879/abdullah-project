...
def create_message():
    ...
    message_json_body["job_title_text"] = base_api.generate_string()
    # message_json_body["badge_type"] = base_api.generate_id()
    # message_json_body["phone_number"] = base_api.generate_numbers()
    # message_json_body["age_group"] = base_api.generate_group()
    message_json_body["industry"] = base_api.generate_industry()
    # message_json_body["province"] = base_api.generate_string()
    # message_json_body["gender"] = base_api.generate_string()
    # message_json_body["interest_topic_category_ids"] = base_api.generate_list()
    # message_json_body["interest_session_category_ids"] = base_api.generate_list()
    # message_json_body["event_goal_ids"] = base_api.generate_list()
    # message_json_body["connection_goal_ids"] = base_api.generate_list()
...
def create_message_json():
    ...
    message_json_body = {
        ...
        "message_key": "AttendeeProfileUpdatedGA",
        "message_version": "V1",
